...
/** [See type definition](https://app.contentful.com/spaces/vxfcs45w12a4/content_types/project) */
...
export type PostImageFragment = { __typename?: 'Asset', url?: string | null };

export type PostsQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsQuery = { __typename?: 'Query', projectCollection?: { __typename?: 'ProjectCollection', total: number, items: Array<{ __typename?: 'Project', title?: string | null, description?: string | null, image?: (
        { __typename?: 'Asset' }
        & PostImageFragment
...
export function PostsQuerySdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
...
export type Sdk = ReturnType<typeof PostsQuerySdk>;